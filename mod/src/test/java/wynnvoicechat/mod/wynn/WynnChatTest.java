...
class WynnChatTest {
    ...
    static final String P1 = "\uDAFF\uDFFC\uE005\uDAFF\uDFFF\uE002\uDAFF\uDFFE ";
    /** Prefix on continuation lines and on some notifications. */
    static final String P2 = "\uDAFF\uDFFC\uE001\uDB00\uDC06 ";
    ...
    @Test
    void worldEventIconIsAPrefixToo() {
        assertEquals("The Haywire Defender World Event starts in 1m 58s!",
                WynnChat.body("\uDAFF\uDFFC\uE00D\uDAFF\uDFFF\uE002\uDAFF\uDFFE The Haywire Defender World Event starts in 1m 58s!"));
    }
